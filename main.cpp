...
void modificarEstudiante() {
    ...
    if(archivo.is_open() && temp.is_open()){
        while (archivo >> nuevo.nombre >> nuevo.carnet >> nuevo.edad)
        cout<<"Ingrese el carnet a actualizar: ";
        cin>>buscar;

        cout<<"Ingrese datos nuevos: ";
        cout << "Nombre (sin espacios): ";
        cin >> nuevo.nombre;
        cout << "Carnet: ";
        cin >> nuevo.carnet;
        ...
        if (e.carnet == buscar){
                cambio = true;
                //archivo >> nuevo.nombre >> nuevo.carnet >> nuevo.edad;
        }
        else {
